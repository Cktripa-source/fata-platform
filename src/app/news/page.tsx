...
export default function NewsPage() {
  return (
    <div className="container py-12 px-4 md:px-8 m-auto">
      <header className="text-center mb-12">
        <h1 className="text-4xl md:text-5xl font-headline font-bold text-amber-800">News & Media</h1>
      ...
      <section className="mb-16">
        <h2 className="text-3xl md:text-4xl font-headline font-semibold text-center mb-8 text-amber-700">Latest Updates</h2>
          ...
          {newsArticles.map((article) => (
            <Card key={article.title} className="flex flex-col shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent className="pt-4 flex-grow">
                <p className="text-sm text-amber-600 font-semibold">{article.category}</p>
              ...
              <CardFooter className="flex justify-between items-center">
                ...
                <Button variant="link" className="p-0 h-auto text-amber-800">Read More</Button>
              </CardFooter>
            </Card>
          ))}
        </div>
      ...
      <div className="grid lg:grid-cols-2 gap-12">
        <section>
          <h2 className="text-3xl md:text-4xl font-headline font-semibold text-center mb-8 text-amber-800">Image Gallery</h2>
        ...
        <section>
          <h2 className="text-3xl md:text-4xl font-headline font-semibold text-center mb-8 text-amber-700">Video Content</h2>
          <div className="space-y-4">
            <Card className="flex items-center p-4 hover:bg-secondary/50 transition-colors">
              <PlayCircle className="h-12 w-12 text-amber-600 mr-4" />
              <div>
